# Human Pose Dataset 5600 Images Supports Yolo Format Electronic Documentary

# Body

Human Pose Dataset, 5600 Images, Supports Yolo Format, Electronic Document Type

This is suitable for projects related to target detection and pose recognition. The images are rich in content, including various postures such as sitting, standing, lying down, etc., which are very practical for training models
